...
class ProfileHeader: UICollectionReusableView {
    ...
    override init(frame: CGRect){
        ...
        /*
        let topDivider = UIView()//구분선
        topDivider.backgroundColor = .lightGray
        
        let bottomDivider = UIView()//구분선
        ...
        topDivider.anchor(top: buttonStack.topAnchor, bottom: buttonStack.topAnchor, right: rightAnchor, height: 0.5)
